...
function checkout(e) {
      ...
      for (let list in listOrder) {
            for (let pro in pros) {
                  ...
                  if (nameOne.includes(nameTwo)) {
                        if (listData.listProducts[pro].quanlityall < listData.listOders[list].qulities) {
                              ...
                              // listData.listProductsCopy[pro].quanlityall -= listData.listOders[list].qulities;
                              // listData.listProductsCopy.splice(0, listOrder.length)
      ...
      // let orders = listData.listOders;
      // let itemOrder = 0;
      // for (let order of orders) {
      //       itemOrder += parseInt(order.qulities);
      //       console.log(itemOrder);
      //       listData.listProductsCopy.quanlityall = listData.listProductsCopy.quanlityall - itemOrder;
      // }
